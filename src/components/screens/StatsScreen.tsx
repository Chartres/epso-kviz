  ...
  const stats = [
    {
      ...
      label: 'Mastered',
      value: sum.mastered,
      info: 'Questions answered correctly 2× in a row — then considered learned.',
    },
    {
      testId: 'stat-answered',
      label: 'Practiced',
      value: sum.answered,
      info: "How many distinct questions you've seen at least once.",
    },
    {
      testId: 'stat-accuracy',
      label: 'Accuracy',
      value: `${Math.round(sum.accuracy * 100)}%`,
      info: 'Share of correct answers across all your attempts.',
    },
  ]
            ...
            <div key={c.id}>
              <div className="mb-1 flex items-baseline justify-between gap-2 text-sm">
                ...
                <span className="font-mono text-xs text-steel-500 tabular-nums">
                  {mastered} mastered · {seen} practiced / {c.count}
                </span>
              </div>
              {/* practiced (seen) as the bar; mastered shown numerically above */}
